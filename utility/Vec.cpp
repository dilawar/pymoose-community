...
Vec::Vec(double a0, double a1, double a2) : a0_(a0), a1_(a1), a2_(a2)
{
    ;
}
...
{
    return Vec(a0_ + k * (end.a0_ - a0_), a1_ + k * (end.a1_ - a1_),
               a2_ + k * (end.a2_ - a2_));
}

bool Vec::operator==(const Vec& other) const
{
    return doubleEq(a0_, other.a0_) && doubleEq(a1_, other.a1_) &&
