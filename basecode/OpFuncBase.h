...
public:
    HopIndex(unsigned short bindIndex, unsigned char hopType = MooseSendHop)
        : bindIndex_(bindIndex), hopType_(hopType)
    {
        ;
    }
...
template <class A>
class OpFunc1Base : public OpFunc {
public:
    bool checkFinfo(const Finfo* s) const
    {
    ...
    void opVecBuffer(const Eref& e, double* buf) const
    {
        ...
        if (elm->hasFields())  // Assignment is to field array.
        {
            ...
            unsigned int nf = elm->numField(di - elm->localDataStart());
...
class OpFunc2Base : public OpFunc {
public:
    bool checkFinfo(const Finfo* s) const
    {
    ...
    void opVecBuffer(const Eref& e, double* buf) const
    {
        ...
        for (unsigned int i = start; i < end; ++i) {
            ...
            for (unsigned int j = 0; j < nf; ++j) {
                Eref er(elm, i, j);
                op(er, temp1[k % temp1.size()], temp2[k % temp2.size()]);
                ++k;
            }
        }
    }

    virtual void opVec(const Eref& e, const vector<A1>& arg1,
...
class OpFunc3Base : public OpFunc {
public:
    bool checkFinfo(const Finfo* s) const
    {
    ...
    void opBuffer(const Eref& e, double* buf) const
    {
        ...
        op(e, arg1, arg2, Conv<A3>::buf2val(&buf));
    }
...
public:
    ...
    void opBuffer(const Eref& e, double* buf) const
    {
        ...
        op(e, arg1, arg2, arg3, Conv<A4>::buf2val(&buf));
    }
...
public:
    ...
    void opBuffer(const Eref& e, double* buf) const
    {
        ...
        op(e, arg1, arg2, arg3, arg4, Conv<A5>::buf2val(&buf));
    }
...
public:
    ...
    virtual void op(const Eref& e, A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5,
                    A6 arg6) const = 0;
    ...
    void opBuffer(const Eref& e, double* buf) const
    {
        ...
        op(e, arg1, arg2, arg3, arg4, arg5, Conv<A6>::buf2val(&buf));
    }
...
class LookupGetOpFuncBase : public OpFunc {
public:
    bool checkFinfo(const Finfo* s) const
    {
        return (dynamic_cast<const SrcFinfo1<A>*>(s) ||
    ...
    virtual void op(const Eref& e, L index, ObjId recipient,
                    FuncId fid) const = 0;
