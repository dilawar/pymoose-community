...
# This is a server. DEPRECATED, SEE flask.py instead.

# It accepts simulation request on a specified TCP port
# (default 31417, think π ). It simulates the given file (usually a archive
# file e.g., tar.bz2) and sends back artefacts generated by simulation (mostly
# images); and streams data from moose.Tables back to client.
